...
const Signup = () => {
  ...
  // ✅ 1. Send OTP to Email
  const sendOtp = async () => {
    const response = await fetch("https://lms-server-production-4d02.up.railway.app/api/auth/send-otp", {
      method: "POST",
  ...
  const verifyOtp = async () => {
    const response = await fetch("https://lms-server-production-4d02.up.railway.app/api/auth/verify-otp", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const handleSignup = async (e) => {
    ...
    const response = await fetch("https://lms-server-production-4d02.up.railway.app/api/auth/signup", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
